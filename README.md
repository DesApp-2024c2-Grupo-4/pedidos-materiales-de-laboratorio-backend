...
| CORS_ENABLED_ORIGINS    | Origins enabled for CORS separated by character ';'.             | String[]      |                   |
...
| DEFAULT_ADMIN_ROLE      | Default admin account roles separated by character ';'.          | String[]      | admin;lab         |
